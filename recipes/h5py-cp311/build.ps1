# recipes/h5py-cp311/build.ps1 — Windows from-source build (STUB).
#
...
Write-Error "h5py-cp311: Windows from-source build not yet implemented (MSVC + vcpkg HDF5_DIR port pending). Use the prebuilt wheel column on Windows."
exit 1
