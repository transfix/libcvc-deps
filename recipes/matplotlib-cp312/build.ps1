...
if ($LASTEXITCODE -ne 0 -or -not $pb11) { throw "matplotlib-cp312: python -m pybind11 --pkgconfigdir failed" }
...
if ($LASTEXITCODE -ne 0 -or -not $pb11inc) { throw "matplotlib-cp312: pybind11.get_include() failed" }
