...
& emconfigure $gitBash -c "$emToolExports && cd '$msysSourceDir' && ./configure --prefix='$msysPrefix' --host=none-none-none --disable-shared --enable-static --with-pic --disable-examples --disable-applications --disable-openmp --with-fftw3-includedir='$msysFftwPrefix/include' --with-fftw3-libdir='$msysFftwPrefix/lib' CFLAGS='-O3 -ffast-math'"
