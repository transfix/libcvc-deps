...
#   ranlib.exe: '/c/.../install/lib/libopus.a': No such file
...
$cmd = "$depsFlag cd '$msysSource' && ./configure --prefix='$winPrefix' --host=x86_64-w64-mingw32 $sharedFlag --disable-dependency-tracking --disable-extra-programs --disable-doc --enable-custom-modes && make -j $jobs && make install"
