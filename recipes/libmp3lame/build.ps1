...
$cmd = "$depsFlag cd '$msysSource' && ./configure --prefix='$msysPrefix' --host=x86_64-w64-mingw32 $sharedFlag --disable-dependency-tracking --disable-frontend --disable-doc && make -j $jobs && make install"
