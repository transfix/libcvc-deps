#!/usr/bin/env bash
# recipes/torch-cp313/build.sh — install the pinned PyTorch 2.8.0 CPU wheel into
# the python313 interpreter's site-packages. The wheel is fetched + sha256-verified
