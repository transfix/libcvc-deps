#!/usr/bin/env bash
# recipes/torch-cp313t/build.sh — install the pinned PyTorch 2.8.0 CPU wheel into
# the python313t interpreter's site-packages. The wheel is fetched + sha256-verified
